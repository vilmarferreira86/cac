...
//	Page<Colaborador> findByNomeContainingOrEmailContainingAllIgnoreCase(String nome, String email, Pageable pageable);
	...
	Page<Colaborador> findByNomeContainingOrEmailContainingOrCelularContainingOrProfissaoContaining(String nome, String email, String celular, String profissao, Pageable pageable);
